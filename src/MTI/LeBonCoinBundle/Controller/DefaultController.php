...
class DefaultController extends Controller
{
    ...
    public function offersAction(Request $request)
    {
        ...
        /*$nb_total = $html->find('ul[class=navlist type]', 0)->find('li', 0)->find('b', 0);
        if ($nb_total != null) {
            $nb_total = $nb_total->plaintext;
            $nb_curr = $html->find('ul[class=navlist type]', 0)->find('li', 0)->find('span[class=value]', 0)->plaintext;
        }
        else {
            $nb_total = $html->find('ul[class=navlist type]', 0)->find('li', 0)->find('span[class=value]', 0)->plaintext;
            $nb_curr = null;
        }
        $nb_individual = $html->find('ul[class=navlist type]', 0)->find('li', 1);
        if ($nb_individual != null) $nb_individual = $nb_individual->find('span[class=value]', 0)->plaintext;
        $nb_professional = $html->find('ul[class=navlist type]', 0)->find('li', 2);
